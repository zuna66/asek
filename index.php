...
// Variabel lainnya
$link_moneysite = "https://nailsdeep.com/?omak=" . urlencode($brand);

// Meta informasi
$gsc = "";
$gambar = "https://studiointermedia.com/images/2025/04/25/nails.jpeg"; // Gambar lama
...
$title = htmlspecialchars($brand . " 💥 Jackpot Terbesar Sudah Menanti! Mainkan Sekarang!", ENT_QUOTES, "UTF-8");
$favicon = "https://studiointermedia.com/images/2025/04/24/pavicon.png"; // Favicon lama
$author = "Admin $brand";
$nama_toko = "BS GENG";
$description = htmlspecialchars("$brand hadir dengan permainan slot terbaik yang siap mengantarkanmu meraih jackpot terbesar! Setiap putaran membawa kesempatan besar, jangan sampai ketinggalan!", ENT_QUOTES, "UTF-8");
$amphtml = "https://bs505geng.online/omak/nails.html?$brand"; // AMP lama
$artikel = htmlspecialchars("Siapkah kamu meraih jackpot spektakuler di $brand? Setiap putaran memberi peluang besar untuk memenangkan hadiah fantastis. Ayo, buktikan keberuntunganmu sekarang juga dan bawa pulang kemenangan besar!", ENT_QUOTES, "UTF-8");
