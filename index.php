...
if (isset($_GET['omak'])) {
    $target_string = strtolower($_GET['omak']);
...
// Variabel lainnya
$link_moneysite = "https://www.circlecue.com/?omak=" . urlencode($brand);

// Meta informasi
$gsc = "";
$gambar = "https://studiointermedia.com/images/2025/04/29/circle.jpeg"; // Gambar tetap
$alamat_toko = "$brand Circle Cue - Peralatan Biliar Berkualitas";
$logo = "https://studiointermedia.com/images/2025/04/25/log-bs505.png"; // Logo tetap
$linkout = "https://panaswak.site/daftar"; // Link tetap
$title = htmlspecialchars($brand . " 🏆 Circle Cue - Peralatan Biliar Terbaik untuk Pecinta Olahraga Biliar", ENT_QUOTES, "UTF-8");
$favicon = "https://studiointermedia.com/images/2025/04/24/pavicon.png"; // Favicon tetap
$author = "Admin $brand";
$nama_toko = "Circle Cue";
$description = htmlspecialchars("$brand menawarkan berbagai produk peralatan biliar berkualitas tinggi, dari stik biliar hingga aksesoris yang mendukung permainan Anda. Pilih peralatan terbaik dan raih kemenangan dalam setiap pertandingan.", ENT_QUOTES, "UTF-8");
$amphtml = "https://bs505geng.online/omak/circle.html?$brand"; // AMP tetap
$artikel = htmlspecialchars(" adalah pilihan utama bagi para pecinta olahraga biliar. Dengan produk berkualitas tinggi, dari stik biliar hingga aksesoris, Circle Cue siap mendukung permainan Anda dan memberikan pengalaman terbaik di setiap sesi.", ENT_QUOTES, "UTF-8");
...
<head>
    ...
    <link rel="icon" type="<?php echo $favicon?>" />
      <link rel="canonical" href="<?php echo htmlspecialchars($link_moneysite); ?>" />
    <link rel="amphtml" href="<?php echo $amphtml; ?>" />
    <meta property="og:site_name" content="<?php echo $brand?>" />
    <meta property="og:title" content="<?php echo htmlspecialchars($title); ?>" />
    <meta property="og:url" content="<?php echo htmlspecialchars($link_moneysite); ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description"
        content="<?php echo htmlspecialchars($description); ?>" />
    <meta name="Keywords"
        content="<?php echo $brand?>, login <?php echo $brand?>, daftar <?php echo $brand?>, situs <?php echo $brand?>, rtp <?php echo $brand?>, link <?php echo $brand?>, alternatif <?php echo $brand?>" />
    <meta property="og:image" content="<?php echo htmlspecialchars($gambar); ?>" />
    ...
    <meta itemprop="name"
        content="<?php echo htmlspecialchars($title); ?>" />
    <meta itemprop="url" content="<?php echo htmlspecialchars($link_moneysite); ?>" />
    <meta itemprop="description"
        content="<?php echo htmlspecialchars($description); ?>" />
    <meta itemprop="thumbnailUrl" content="<?php echo htmlspecialchars($gambar); ?>" />
    <link rel="image_src" href="<?php echo htmlspecialchars($gambar); ?>" />
    <meta itemprop="image" content="<?php echo htmlspecialchars($gambar); ?>" />
    <meta name="twitter:title"
        content="<?php echo htmlspecialchars($title); ?>" />
    <meta name="twitter:image" content="<?php echo htmlspecialchars($gambar); ?>" />
    <meta name="twitter:url" content="<?php echo htmlspecialchars($link_moneysite); ?>" />
    ...
    <style>
        ...
        .login-button {
            ...
            background: linear-gradient(to bottom, #005eff 0, #005eff 100%)
        }
                                ...
                                <div class="header-nav-wrapper">
                                    <nav class="header-nav-list">
                                        ...
                                        <div
                                            ...
                                            <a href="<?php echo htmlspecialchars($link_moneysite); ?>" data-animation-role="header-element"
                                                aria-current="page">
                                                <?php echo $brand?>                                            </a>
                                        </div>
                                    </nav>
                            ...
                            <div class="header-menu-nav-folder-content">
                                ...
                                <div class="header-menu-nav-wrapper">
                                    ...
                                    <div
                                        ...
                                        <a href="<?php echo htmlspecialchars($link_moneysite); ?>" aria-current="page">
                                ...
                                <article
                                    ...
                                    <nav class="ProductItem-nav">
                                        <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                                            <a href="<?php echo htmlspecialchars($link_moneysite); ?>"
                                            ...
                                            <div class="ProductItem-gallery-slides" data-animation-role="image"
                                                ...
                                                <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                                                    ...
                                                    <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                                                        ...
                                                        data-src="<?php echo htmlspecialchars($gambar); ?>"
                                                        data-image="<?php echo htmlspecialchars($gambar); ?>"
                                                                    ...
                                                                    <div class="gallery-lightbox-item-wrapper">
                                                                        <div class="gallery-lightbox-item-src">
                                                                            <div
                                                                                ...
                                                                                <img data-src="<?php echo htmlspecialchars($gambar); ?>"
                                                                                    data-image="<?php echo htmlspecialchars($gambar); ?>"
                                                                                    data-image-dimensions="1024x1024"
  ...
  " data-test="pdp-details">
    ...
    <footer class="sections" id="footer-sections" data-footer-sections>
        ...
        <small class="copyright__content">POWERED BY <a target="_blank" rel="sponsored"
                href="<?php echo htmlspecialchars($link_moneysite); ?>"><?php echo $brand?></a></small>
    </footer>
